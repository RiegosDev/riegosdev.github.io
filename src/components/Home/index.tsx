    ...
    <main className='relative min-h-screen text-foreground overflow-hidden font-sans antialiased'>
      ...
      <div className='relative z-10 pt-32 pb-20 px-6 max-w-7xl mx-auto space-y-32'>
        ...
        <section className='text-center space-y-8 max-w-4xl mx-auto mt-10'>
          <h1 className='sm:text-3xl md:text-4xl font-extrabold tracking-tight text-foreground leading-tight'>
          ...
          <div className='relative z-10 max-w-2xl'>
            ...
            <div className='flex gap-4 items-center'>
              <div className='flex -space-x-4'>
                <div className='w-12 h-12 rounded-full bg-card border-2 border-background flex items-center justify-center text-xs font-bold text-foreground'>
                  D
                </div>
                <div className='w-12 h-12 rounded-full bg-muted border-2 border-background flex items-center justify-center text-xs font-bold text-foreground'>
                  T
                </div>
              </div>
